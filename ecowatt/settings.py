"""
Django settings for ecowatt project.
...
SECRET_KEY = 'django-insecure-g)oo6y3&1=a@xhu7&*vfz__nypjgvx)%yreo_hz^tj(ueejils'
...
STATICFILES_DIRS = [
    ...
    # os.path.join(BASE_DIR, 'energy', 'static'),  # Additional static directory for the 'energy' app
]
